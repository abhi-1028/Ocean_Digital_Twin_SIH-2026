...
/*
 * Mock Argo observations
 *
 * These are derived from the float locations above.
 * They are used by the existing API hooks until
...
/*
 * Mock ocean model points
 *
 * These provide a small synthetic model field for
 * the existing ocean-data hook.
 */
